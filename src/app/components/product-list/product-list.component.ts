...
export class ProductListComponent implements OnInit {
    ...
    constructor(public productService: ProductService, private categoryService: CategoryService) {}
    ...
    async saveEdit(event: { index: number, product: Product }) {
        //this.productService.updateProduct(event.index, event.product);
        const original = this.filteredProducts()[event.index];
        await this.productService.updateProduct(original.id, event.product);
